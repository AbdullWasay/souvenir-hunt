  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "py-3" : "py-6"}`}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className={`flex items-center justify-between gap-4 rounded-full px-4 sm:px-6 py-3 transition-all duration-500 ${scrolled ? "border border-border/70 bg-white/80 backdrop-blur-xl shadow-paper" : "border border-white/60 bg-white/40 backdrop-blur-md shadow-[0_4px_24px_-12px_oklch(0.42_0.2_252/0.25)]"}`}>
